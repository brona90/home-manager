...
- **An edit did not stick.** Someone changed `~/.claude/settings.json`,
  `~/.claude/CLAUDE.md`, or a Doom config file directly and the change vanished
  or never appeared. Find the owning module and make the change there.
