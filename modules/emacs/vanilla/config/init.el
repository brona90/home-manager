...
;; hand-write, because they change on every rebuild (GNU diff for claude-diff,
;; lilypond's binary and its site-lisp directory).
;;
...
(require 'my-lang)
;; my-lilypond.el is separate from my-lang.el on purpose. Every other language
;; here is a `:mode' line; LilyPond brings a mode shim, a flymake backend and
;; an async build-on-save with it, and folding all that into the language table
;; would bury both.
(require 'my-lilypond)
